      ...
      children: [
        OcgCard(
          child: Column(
            ...
            children: [
              const Text('Citas', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
              const SizedBox(height: 8),
              Text('Paciente: ${patient.nombre}'),
              const SizedBox(height: 4),
              const Text('Integración de listado de citas: siguiente iteración del bloque activo.'),
            ],
          ),
        ),
      ],
