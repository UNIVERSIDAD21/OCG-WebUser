...
import 'package:ocg_proyect/shared/widgets/ocg_loading_state.dart';
...
class _PatientProfileScreenState extends ConsumerState<PatientProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget content = patientAsync.when(
      loading: () => ocgLoading(label: 'Cargando tu perfil...'),
                ...
                children: [
                  ...
                  Center(
                    child: _ProfileAvatar(
                      ...
                      onTap: () => _pickAndUploadPhoto(patient.id),
                    ),
                  ),
                  const SizedBox(height: 12),
  ...
  Future<void> _pickAndUploadPhoto(String patientId) async {
    ...
    try {
      ...
      final storageRef = FirebaseStorage.instance.ref(
        StoragePaths.patientProfile(patientId),
      );
...
class _ProfileAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final initial = patient.nombre.isNotEmpty
