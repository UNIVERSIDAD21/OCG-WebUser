...
2. Los tabs de `PatientDetailScreen` (`patient_treatment_tab.dart`, `patient_payments_tab.dart`, `patient_simulator_tab.dart`) existen como estructura vacía — se llenarán en sus bloques correspondientes.
